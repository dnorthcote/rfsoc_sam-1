-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_src_WaveformGen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_src_WaveformGen
-- Source Path: frequency_synth/Frequency Synthesis/NCO Generator 0/NCO HDL Optimized/WaveformGen
-- Hierarchy Level: 3
-- 
...
ENTITY frequency_synth_src_WaveformGen IS
...
END frequency_synth_src_WaveformGen;


ARCHITECTURE rtl OF frequency_synth_src_WaveformGen IS

  -- Component Declarations
  COMPONENT frequency_synth_src_LookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : frequency_synth_src_LookUpTableGen
    USE ENTITY work.frequency_synth_src_LookUpTableGen(rtl);
...
BEGIN
  u_SineWave_inst : frequency_synth_src_LookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_CosineWave_inst : frequency_synth_src_LookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
