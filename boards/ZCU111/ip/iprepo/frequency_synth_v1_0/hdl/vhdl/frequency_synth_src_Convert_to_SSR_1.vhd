-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_src_Convert_to_SSR_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_src_Convert_to_SSR_1
-- Source Path: frequency_synth/Frequency Synthesis/Convert to SSR 1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frequency_synth_src_Convert_to_SSR_1 IS
...
END frequency_synth_src_Convert_to_SSR_1;


ARCHITECTURE rtl OF frequency_synth_src_Convert_to_SSR_1 IS

  -- Component Declarations
  COMPONENT frequency_synth_src_Vector_to_SSR_Low_block
  ...
  FOR ALL : frequency_synth_src_Vector_to_SSR_Low_block
    USE ENTITY work.frequency_synth_src_Vector_to_SSR_Low_block(rtl);
...
BEGIN
  u_Vector_to_SSR_Low : frequency_synth_src_Vector_to_SSR_Low_block
