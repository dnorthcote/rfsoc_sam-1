-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_src_NCO_Generator_0.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_src_NCO_Generator_0
-- Source Path: frequency_synth/Frequency Synthesis/NCO Generator 0
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frequency_synth_src_NCO_Generator_0 IS
...
END frequency_synth_src_NCO_Generator_0;


ARCHITECTURE rtl OF frequency_synth_src_NCO_Generator_0 IS

  -- Component Declarations
  COMPONENT frequency_synth_src_NCO_HDL_Optimized
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : frequency_synth_src_NCO_HDL_Optimized
    USE ENTITY work.frequency_synth_src_NCO_HDL_Optimized(rtl);
...
BEGIN
  u_NCO_HDL_Optimized : frequency_synth_src_NCO_HDL_Optimized
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
