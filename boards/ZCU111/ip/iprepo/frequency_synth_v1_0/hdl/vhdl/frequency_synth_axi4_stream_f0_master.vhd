-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_axi4_stream_f0_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_axi4_stream_f0_master
-- Source Path: frequency_synth/frequency_synth_axi4_stream_f0_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frequency_synth_axi4_stream_f0_master IS
...
END frequency_synth_axi4_stream_f0_master;


ARCHITECTURE rtl OF frequency_synth_axi4_stream_f0_master IS

  -- Component Declarations
  COMPONENT frequency_synth_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT frequency_synth_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : frequency_synth_fifo_data_OUT
    USE ENTITY work.frequency_synth_fifo_data_OUT(rtl);

  FOR ALL : frequency_synth_fifo_TLAST_OUT
    USE ENTITY work.frequency_synth_fifo_TLAST_OUT(rtl);
  ...
  SIGNAL write_packet_size_axi4_stream_f0_master_unsigned : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_frequency_synth_fifo_data_OUT_inst : frequency_synth_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              In_rsvd => user_data,  -- ufix128
              Push => user_valid,  -- ufix1
              Pop => AXI4_Stream_F0_Master_TREADY,  -- ufix1
              Out_rsvd => AXI4_Stream_F0_Master_TDATA_tmp,  -- ufix128
              Empty => fifo_empty_data,  -- ufix1
              AFull => fifo_afull_data  -- ufix1
              );

  u_frequency_synth_fifo_TLAST_OUT_inst : frequency_synth_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              ...
              Push => user_valid,  -- ufix1
              Pop => AXI4_Stream_F0_Master_TREADY,  -- ufix1
              Out_rsvd => AXI4_Stream_F0_Master_TLAST  -- ufix1
              );

  AXI4_Stream_F0_Master_TVALID <=  NOT fifo_empty_data;

  write_packet_size_axi4_stream_f0_master_unsigned <= unsigned(write_packet_size_axi4_stream_f0_master);

  const_1 <= to_unsigned(1, 32);

  tlast_size_value <= write_packet_size_axi4_stream_f0_master_unsigned - const_1;
