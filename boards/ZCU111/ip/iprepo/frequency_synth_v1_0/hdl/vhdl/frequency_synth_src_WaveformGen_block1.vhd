-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_src_WaveformGen_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_src_WaveformGen_block1
-- Source Path: frequency_synth/Frequency Synthesis/NCO Generator 2/NCO HDL Optimized/WaveformGen
-- Hierarchy Level: 3
-- 
...
ENTITY frequency_synth_src_WaveformGen_block1 IS
...
END frequency_synth_src_WaveformGen_block1;


ARCHITECTURE rtl OF frequency_synth_src_WaveformGen_block1 IS

  -- Component Declarations
  COMPONENT frequency_synth_src_LookUpTableGen_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : frequency_synth_src_LookUpTableGen_block1
    USE ENTITY work.frequency_synth_src_LookUpTableGen_block1(rtl);
...
BEGIN
  u_SineWave_inst : frequency_synth_src_LookUpTableGen_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_CosineWave_inst : frequency_synth_src_LookUpTableGen_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
