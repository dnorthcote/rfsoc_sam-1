-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_src_NCO_HDL_Optimized_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_src_NCO_HDL_Optimized_block1
-- Source Path: frequency_synth/Frequency Synthesis/NCO Generator 2/NCO HDL Optimized
-- Hierarchy Level: 2
-- 
-- NCO HDL Optimized
-- 
...
ENTITY frequency_synth_src_NCO_HDL_Optimized_block1 IS
...
END frequency_synth_src_NCO_HDL_Optimized_block1;


ARCHITECTURE rtl OF frequency_synth_src_NCO_HDL_Optimized_block1 IS

  -- Component Declarations
  COMPONENT frequency_synth_src_PhaseMul_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT frequency_synth_src_WaveformGen_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : frequency_synth_src_PhaseMul_block1
    USE ENTITY work.frequency_synth_src_PhaseMul_block1(rtl);

  FOR ALL : frequency_synth_src_WaveformGen_block1
    USE ENTITY work.frequency_synth_src_WaveformGen_block1(rtl);
...
BEGIN
  u_pinc_mul : frequency_synth_src_PhaseMul_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_wavegen_4 : frequency_synth_src_WaveformGen_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_wavegen_4_1 : frequency_synth_src_WaveformGen_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_wavegen_4_2 : frequency_synth_src_WaveformGen_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_wavegen_4_3 : frequency_synth_src_WaveformGen_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
