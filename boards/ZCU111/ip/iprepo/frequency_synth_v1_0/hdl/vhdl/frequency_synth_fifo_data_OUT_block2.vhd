-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_fifo_data_OUT_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_fifo_data_OUT_block2
-- Source Path: frequency_synth/frequency_synth_axi4_stream_f3_master/frequency_synth_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frequency_synth_fifo_data_OUT_block2 IS
...
END frequency_synth_fifo_data_OUT_block2;


ARCHITECTURE rtl OF frequency_synth_fifo_data_OUT_block2 IS

  -- Component Declarations
  COMPONENT frequency_synth_SimpleDualPortRAM_generic
  ...
  FOR ALL : frequency_synth_SimpleDualPortRAM_generic
    USE ENTITY work.frequency_synth_SimpleDualPortRAM_generic(rtl);
  ...
  SIGNAL cache_data                       : unsigned(127 DOWNTO 0);  -- ufix128
  SIGNAL data_out_next                    : unsigned(127 DOWNTO 0);  -- ufix128
  SIGNAL Out_tmp                          : unsigned(127 DOWNTO 0);  -- ufix128
  SIGNAL afull_num                        : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL relop_relop1_1                   : std_logic;

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_frequency_synth_fifo_data_OUT_classic_ram : frequency_synth_SimpleDualPortRAM_generic
