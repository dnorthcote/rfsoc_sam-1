-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_fifo_TLAST_OUT
-- Source Path: frequency_synth/frequency_synth_axi4_stream_f0_master/frequency_synth_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frequency_synth_fifo_TLAST_OUT IS
...
END frequency_synth_fifo_TLAST_OUT;


ARCHITECTURE rtl OF frequency_synth_fifo_TLAST_OUT IS
...
BEGIN
  ...
  u_frequency_synth_fifo_TLAST_OUT_classic_ram_singlebit : frequency_synth_SimpleDualPortRAM_singlebit
