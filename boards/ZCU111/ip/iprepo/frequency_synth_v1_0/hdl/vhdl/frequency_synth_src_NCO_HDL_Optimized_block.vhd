-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_src_NCO_HDL_Optimized_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_src_NCO_HDL_Optimized_block
-- Source Path: frequency_synth/Frequency Synthesis/NCO Generator 1/NCO HDL Optimized
-- Hierarchy Level: 2
-- 
-- NCO HDL Optimized
-- 
...
ENTITY frequency_synth_src_NCO_HDL_Optimized_block IS
...
END frequency_synth_src_NCO_HDL_Optimized_block;


ARCHITECTURE rtl OF frequency_synth_src_NCO_HDL_Optimized_block IS

  -- Component Declarations
  COMPONENT frequency_synth_src_PhaseMul_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT frequency_synth_src_WaveformGen_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : frequency_synth_src_PhaseMul_block
    USE ENTITY work.frequency_synth_src_PhaseMul_block(rtl);

  FOR ALL : frequency_synth_src_WaveformGen_block
    USE ENTITY work.frequency_synth_src_WaveformGen_block(rtl);
...
BEGIN
  u_pinc_mul : frequency_synth_src_PhaseMul_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_wavegen_4 : frequency_synth_src_WaveformGen_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_wavegen_4_1 : frequency_synth_src_WaveformGen_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_wavegen_4_2 : frequency_synth_src_WaveformGen_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_wavegen_4_3 : frequency_synth_src_WaveformGen_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
