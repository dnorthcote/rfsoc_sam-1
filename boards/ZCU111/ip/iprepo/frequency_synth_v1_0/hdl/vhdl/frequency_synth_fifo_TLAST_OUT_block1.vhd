-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_fifo_TLAST_OUT_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_fifo_TLAST_OUT_block1
-- Source Path: frequency_synth/frequency_synth_axi4_stream_f2_master/frequency_synth_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frequency_synth_fifo_TLAST_OUT_block1 IS
...
END frequency_synth_fifo_TLAST_OUT_block1;


ARCHITECTURE rtl OF frequency_synth_fifo_TLAST_OUT_block1 IS

  -- Component Declarations
  COMPONENT frequency_synth_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : frequency_synth_SimpleDualPortRAM_singlebit
    USE ENTITY work.frequency_synth_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_frequency_synth_fifo_TLAST_OUT_classic_ram : frequency_synth_SimpleDualPortRAM_singlebit
