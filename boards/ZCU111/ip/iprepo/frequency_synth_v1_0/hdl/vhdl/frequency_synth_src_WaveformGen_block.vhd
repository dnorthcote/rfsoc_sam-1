-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_src_WaveformGen_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_src_WaveformGen_block
-- Source Path: frequency_synth/Frequency Synthesis/NCO Generator 1/NCO HDL Optimized/WaveformGen
-- Hierarchy Level: 3
-- 
...
ENTITY frequency_synth_src_WaveformGen_block IS
...
END frequency_synth_src_WaveformGen_block;


ARCHITECTURE rtl OF frequency_synth_src_WaveformGen_block IS

  -- Component Declarations
  COMPONENT frequency_synth_src_LookUpTableGen_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : frequency_synth_src_LookUpTableGen_block
    USE ENTITY work.frequency_synth_src_LookUpTableGen_block(rtl);
...
BEGIN
  u_SineWave_inst : frequency_synth_src_LookUpTableGen_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_CosineWave_inst : frequency_synth_src_LookUpTableGen_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
