-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_src_Convert_to_SSR_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_src_Convert_to_SSR_2
-- Source Path: frequency_synth/Frequency Synthesis/Convert to SSR 2
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frequency_synth_src_Convert_to_SSR_2 IS
...
END frequency_synth_src_Convert_to_SSR_2;


ARCHITECTURE rtl OF frequency_synth_src_Convert_to_SSR_2 IS

  -- Component Declarations
  COMPONENT frequency_synth_src_Vector_to_SSR_Low_block1
  ...
  FOR ALL : frequency_synth_src_Vector_to_SSR_Low_block1
    USE ENTITY work.frequency_synth_src_Vector_to_SSR_Low_block1(rtl);
...
BEGIN
  u_Vector_to_SSR_Low : frequency_synth_src_Vector_to_SSR_Low_block1
