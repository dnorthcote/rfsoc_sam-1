-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frequency_synth\frequency_synth_src_NCO_Generator_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frequency_synth_src_NCO_Generator_2
-- Source Path: frequency_synth/Frequency Synthesis/NCO Generator 2
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frequency_synth_src_NCO_Generator_2 IS
...
END frequency_synth_src_NCO_Generator_2;


ARCHITECTURE rtl OF frequency_synth_src_NCO_Generator_2 IS

  -- Component Declarations
  COMPONENT frequency_synth_src_NCO_HDL_Optimized_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : frequency_synth_src_NCO_HDL_Optimized_block1
    USE ENTITY work.frequency_synth_src_NCO_HDL_Optimized_block1(rtl);
...
BEGIN
  u_NCO_HDL_Optimized : frequency_synth_src_NCO_HDL_Optimized_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
