-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\dmareference\DataInspector_src_HDL_FIFO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DataInspector_src_HDL_FIFO
-- Source Path: AXI_Data_Inspector/HDL_FIFO
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DataInspector_src_HDL_FIFO IS
...
END DataInspector_src_HDL_FIFO;


ARCHITECTURE rtl OF DataInspector_src_HDL_FIFO IS

  -- Component Declarations
  COMPONENT DataInspector_src_SimpleDualPortRAM_generic
  ...
  FOR ALL : DataInspector_src_SimpleDualPortRAM_generic
    USE ENTITY work.DataInspector_src_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_HDL_FIFO_ram_generic : DataInspector_src_SimpleDualPortRAM_generic
