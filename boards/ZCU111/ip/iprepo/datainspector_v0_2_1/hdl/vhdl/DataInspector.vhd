-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\dmareference\DataInspector.vhd
...
ARCHITECTURE rtl OF DataInspector IS

  -- Component Declarations
  COMPONENT DataInspector_reset_sync
  ...
  COMPONENT DataInspector_axi_lite
  ...
  FOR ALL : DataInspector_reset_sync
    USE ENTITY work.DataInspector_reset_sync(rtl);

  FOR ALL : DataInspector_axi_lite
    USE ENTITY work.DataInspector_axi_lite(rtl);

  FOR ALL : DataInspector_dut
    USE ENTITY work.DataInspector_dut(rtl);
  ...
  SIGNAL write_Transfer                   : std_logic;  -- ufix1
...
BEGIN
  u_DataInspector_reset_sync_inst : DataInspector_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_DataInspector_axi_lite_inst : DataInspector_axi_lite
    PORT MAP( reset => reset,
              ...
              write_Transfer => write_Transfer,  -- ufix1
              write_Reset => write_Reset,  -- ufix1
              reset_internal => reset_internal  -- ufix1
              );

  u_DataInspector_dut_inst : DataInspector_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => write_axi_enable,  -- ufix1
              Transfer => write_Transfer,  -- ufix1
  ...
  ip_timestamp <= to_unsigned(1909091710, 32);
