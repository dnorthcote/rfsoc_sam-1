-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\dmareference\DataInspector_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DataInspector_axi_lite
-- Source Path: DataInspector/DataInspector_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DataInspector_axi_lite IS
...
END DataInspector_axi_lite;


ARCHITECTURE rtl OF DataInspector_axi_lite IS

  -- Component Declarations
  COMPONENT DataInspector_addr_decoder
  ...
  COMPONENT DataInspector_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DataInspector_addr_decoder
    USE ENTITY work.DataInspector_addr_decoder(rtl);

  FOR ALL : DataInspector_axi_lite_module
    USE ENTITY work.DataInspector_axi_lite_module(rtl);
...
BEGIN
  u_DataInspector_addr_decoder_inst : DataInspector_addr_decoder
  ...
  u_DataInspector_axi_lite_module_inst : DataInspector_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
