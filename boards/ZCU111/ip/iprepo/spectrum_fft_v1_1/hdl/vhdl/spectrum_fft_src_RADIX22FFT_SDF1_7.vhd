-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_SDF1_7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_SDF1_7
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_7
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_SDF1_7 IS
...
END spectrum_fft_src_RADIX22FFT_SDF1_7;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_SDF1_7 IS

  -- Component Declarations
  COMPONENT spectrum_fft_src_Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : spectrum_fft_src_Complex4Multiply_block1
    USE ENTITY work.spectrum_fft_src_Complex4Multiply_block1(rtl);

  FOR ALL : spectrum_fft_src_SimpleDualPortRAM_generic
    USE ENTITY work.spectrum_fft_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : spectrum_fft_src_SDFCommutator7
    USE ENTITY work.spectrum_fft_src_SDFCommutator7(rtl);
...
BEGIN
  u_MUL4 : spectrum_fft_src_Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_7 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_7 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 23
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_7 : spectrum_fft_src_SDFCommutator7
    PORT MAP( clk => clk,
              reset => reset,
              din_7_vld_dly => din_7_vld_dly,
