-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_FFT_HDL_Optimized.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_FFT_HDL_Optimized
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized
-- Hierarchy Level: 1
-- 
-- FFT HDL Optimized
-- 
...
USE work.spectrum_fft_src_FFT_pkg.ALL;

ENTITY spectrum_fft_src_FFT_HDL_Optimized IS
...
END spectrum_fft_src_FFT_HDL_Optimized;


ARCHITECTURE rtl OF spectrum_fft_src_FFT_HDL_Optimized IS

  -- Component Declarations
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_SDF1_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_SDF2_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_TWDLROM_3_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_SDF1_3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_SDF2_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_TWDLROM_5_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_SDF1_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_SDF2_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_TWDLROM_7_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_SDF1_7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_SDF2_8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_TWDLROM_9_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_SDF1_9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_SDF2_10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_TWDLROM_11_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_RADIX22FFT_CTRL1_1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          ...
          multiply_11_J                   :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT spectrum_fft_src_RADIX22FFT_SDF1_11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          din_11_re_dly                   :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26_En15
          din_11_im_dly                   :   IN    std_logic_vector(25 DOWNTO 0);  -- sfix26_En15
          din_11_vld_dly                  :   IN    std_logic;
          rd_11_Addr                      :   IN    std_logic;
          rd_11_Enb_dly                   :   IN    std_logic;
          twdl_11_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          twdl_11_im                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          twdl_11_vld                     :   IN    std_logic;
          proc_11_enb                     :   IN    std_logic;
          syncReset                       :   IN    std_logic;
          dout_11_re                      :   OUT   std_logic_vector(26 DOWNTO 0);  -- sfix27_En15
          dout_11_im                      :   OUT   std_logic_vector(26 DOWNTO 0);  -- sfix27_En15
          dout_11_vld                     :   OUT   std_logic;
          dinXTwdl_11_vld                 :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT spectrum_fft_src_RADIX2FFT_bitNatural
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          dout_11_re                      :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En15
          dout_11_im                      :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En15
          dout_11_vld                     :   IN    std_logic;
          syncReset                       :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(26 DOWNTO 0);  -- sfix27_En15
          dout_im1                        :   OUT   std_logic_vector(26 DOWNTO 0);  -- sfix27_En15
  ...
  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_1
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_1(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF1_1
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF1_1(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_2
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_2(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF2_2
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF2_2(rtl);

  FOR ALL : spectrum_fft_src_TWDLROM_3_1
    USE ENTITY work.spectrum_fft_src_TWDLROM_3_1(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_3
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_3(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF1_3
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF1_3(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_4
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_4(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF2_4
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF2_4(rtl);

  FOR ALL : spectrum_fft_src_TWDLROM_5_1
    USE ENTITY work.spectrum_fft_src_TWDLROM_5_1(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_5
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_5(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF1_5
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF1_5(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_6
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_6(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF2_6
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF2_6(rtl);

  FOR ALL : spectrum_fft_src_TWDLROM_7_1
    USE ENTITY work.spectrum_fft_src_TWDLROM_7_1(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_7
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_7(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF1_7
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF1_7(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_8
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_8(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF2_8
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF2_8(rtl);

  FOR ALL : spectrum_fft_src_TWDLROM_9_1
    USE ENTITY work.spectrum_fft_src_TWDLROM_9_1(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_9
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_9(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF1_9
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF1_9(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_10
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_10(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF2_10
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF2_10(rtl);

  FOR ALL : spectrum_fft_src_TWDLROM_11_1
    USE ENTITY work.spectrum_fft_src_TWDLROM_11_1(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_CTRL1_1_block
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_CTRL1_1_block(rtl);

  FOR ALL : spectrum_fft_src_RADIX22FFT_SDF1_11
    USE ENTITY work.spectrum_fft_src_RADIX22FFT_SDF1_11(rtl);

  FOR ALL : spectrum_fft_src_RADIX2FFT_bitNatural
    USE ENTITY work.spectrum_fft_src_RADIX2FFT_bitNatural(rtl);

  -- Signals
  SIGNAL dataIn_re_signed                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dataIn_im_signed                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dataIn_1_cast_re                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dataIn_1_cast_im                 : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL intdelay_reg_next_16             : vector_of_signed26(0 TO 2);  -- sfix26_En15 [3]
  SIGNAL din_11_re_dly                    : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL intdelay_reg_17                  : vector_of_signed26(0 TO 2);  -- sfix26 [3]
  SIGNAL intdelay_reg_next_17             : vector_of_signed26(0 TO 2);  -- sfix26_En15 [3]
  SIGNAL din_11_im_dly                    : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL intdelay_reg_18                  : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL intdelay_reg_next_18             : std_logic_vector(0 TO 2);  -- ufix1 [3]
...
BEGIN
  u_CTRL1_1_1 : spectrum_fft_src_RADIX22FFT_CTRL1_1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDF1_1_1 : spectrum_fft_src_RADIX22FFT_SDF1_1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_CTRL2_2_1 : spectrum_fft_src_RADIX22FFT_CTRL1_2
    PORT MAP( clk => clk,
              reset => reset,
              dout_1_1_vld => dout_1_1_vld,
  ...
  u_SDF2_2_1 : spectrum_fft_src_RADIX22FFT_SDF2_2
    PORT MAP( clk => clk,
              reset => reset,
              dout_1_1_re => dout_1_1_re,  -- sfix17_En15
              dout_1_1_im => dout_1_1_im,  -- sfix17_En15
  ...
  u_twdlROM_3_1 : spectrum_fft_src_TWDLROM_3_1
    PORT MAP( clk => clk,
              reset => reset,
              dout_2_1_vld => dout_2_1_vld,
              syncReset => syncReset,
  ...
  u_CTRL1_3_1 : spectrum_fft_src_RADIX22FFT_CTRL1_3
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDF1_3_1 : spectrum_fft_src_RADIX22FFT_SDF1_3
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_CTRL2_4_1 : spectrum_fft_src_RADIX22FFT_CTRL1_4
    PORT MAP( clk => clk,
              reset => reset,
              dout_3_1_vld => dout_3_1_vld,
  ...
  u_SDF2_4_1 : spectrum_fft_src_RADIX22FFT_SDF2_4
    PORT MAP( clk => clk,
              reset => reset,
              dout_3_1_re => dout_3_1_re,  -- sfix19_En15
              dout_3_1_im => dout_3_1_im,  -- sfix19_En15
  ...
  u_twdlROM_5_1 : spectrum_fft_src_TWDLROM_5_1
    PORT MAP( clk => clk,
              reset => reset,
              dout_4_1_vld => dout_4_1_vld,
              syncReset => syncReset,
  ...
  u_CTRL1_5_1 : spectrum_fft_src_RADIX22FFT_CTRL1_5
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDF1_5_1 : spectrum_fft_src_RADIX22FFT_SDF1_5
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_CTRL2_6_1 : spectrum_fft_src_RADIX22FFT_CTRL1_6
    PORT MAP( clk => clk,
              reset => reset,
              dout_5_1_vld => dout_5_1_vld,
  ...
  u_SDF2_6_1 : spectrum_fft_src_RADIX22FFT_SDF2_6
    PORT MAP( clk => clk,
              reset => reset,
              dout_5_1_re => dout_5_1_re,  -- sfix21_En15
              dout_5_1_im => dout_5_1_im,  -- sfix21_En15
  ...
  u_twdlROM_7_1 : spectrum_fft_src_TWDLROM_7_1
    PORT MAP( clk => clk,
              reset => reset,
              dout_6_1_vld => dout_6_1_vld,
              syncReset => syncReset,
  ...
  u_CTRL1_7_1 : spectrum_fft_src_RADIX22FFT_CTRL1_7
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDF1_7_1 : spectrum_fft_src_RADIX22FFT_SDF1_7
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_CTRL2_8_1 : spectrum_fft_src_RADIX22FFT_CTRL1_8
    PORT MAP( clk => clk,
              reset => reset,
              dout_7_1_vld => dout_7_1_vld,
  ...
  u_SDF2_8_1 : spectrum_fft_src_RADIX22FFT_SDF2_8
    PORT MAP( clk => clk,
              reset => reset,
              dout_7_1_re => dout_7_1_re,  -- sfix23_En15
              dout_7_1_im => dout_7_1_im,  -- sfix23_En15
  ...
  u_twdlROM_9_1 : spectrum_fft_src_TWDLROM_9_1
    PORT MAP( clk => clk,
              reset => reset,
              dout_8_1_vld => dout_8_1_vld,
              syncReset => syncReset,
  ...
  u_CTRL1_9_1 : spectrum_fft_src_RADIX22FFT_CTRL1_9
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDF1_9_1 : spectrum_fft_src_RADIX22FFT_SDF1_9
    PORT MAP( clk => clk,
              reset => reset,
              din_9_1_re_dly => std_logic_vector(din_9_1_re_dly),  -- sfix24_En15
              din_9_1_im_dly => std_logic_vector(din_9_1_im_dly),  -- sfix24_En15
              ...
              proc_9_enb => proc_9_enb,
              syncReset => syncReset,
              dout_9_1_re => dout_9_1_re,  -- sfix25_En15
              dout_9_1_im => dout_9_1_im,  -- sfix25_En15
              dout_9_1_vld => dout_9_1_vld,
              dinXTwdl_9_1_vld => dinXTwdl_9_1_vld
              );

  u_CTRL2_10_1 : spectrum_fft_src_RADIX22FFT_CTRL1_10
    PORT MAP( clk => clk,
              reset => reset,
              dout_9_1_vld => dout_9_1_vld,
  ...
  u_SDF2_10_1 : spectrum_fft_src_RADIX22FFT_SDF2_10
    PORT MAP( clk => clk,
              reset => reset,
              dout_9_1_re => dout_9_1_re,  -- sfix25_En15
              dout_9_1_im => dout_9_1_im,  -- sfix25_En15
              ...
              multiply_10_J => multiply_10_J,
              syncReset => syncReset,
              dout_10_1_re => dout_10_1_re,  -- sfix26_En15
              dout_10_1_im => dout_10_1_im,  -- sfix26_En15
              dout_10_1_vld => dout_10_1_vld,
              dinXTwdl_10_1_vld => dinXTwdl_10_1_vld
              );

  u_twdlROM_11 : spectrum_fft_src_TWDLROM_11_1
    PORT MAP( clk => clk,
              reset => reset,
              dout_10_1_vld => dout_10_1_vld,
              syncReset => syncReset,
              twdl_11_re => twdl_11_re,  -- sfix16_En14
              twdl_11_im => twdl_11_im,  -- sfix16_En14
              twdl_11_vld => twdl_11_vld
              );

  u_CTRLRX2 : spectrum_fft_src_RADIX22FFT_CTRL1_1_block
    PORT MAP( clk => clk,
              reset => reset,
              ...
              multiply_11_J => multiply_11_J
              );

  u_RADIX2 : spectrum_fft_src_RADIX22FFT_SDF1_11
    PORT MAP( clk => clk,
              reset => reset,
              din_11_re_dly => std_logic_vector(din_11_re_dly),  -- sfix26_En15
              din_11_im_dly => std_logic_vector(din_11_im_dly),  -- sfix26_En15
              ...
              proc_11_enb => proc_11_enb,
              syncReset => syncReset,
              dout_11_re => dout_11_re,  -- sfix27_En15
              dout_11_im => dout_11_im,  -- sfix27_En15
              dout_11_vld => dout_11_vld,
              dinXTwdl_11_vld => dinXTwdl_11_vld
              );

  u_NaturalOrder_Stage : spectrum_fft_src_RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              reset => reset,
              dout_11_re => dout_11_re,  -- sfix27_En15
              dout_11_im => dout_11_im,  -- sfix27_En15
              dout_11_vld => dout_11_vld,
              syncReset => syncReset,
              dout_re1 => dout_re1,  -- sfix27_En15
              dout_im1 => dout_im1,  -- sfix27_En15
              dout_vld1 => dout_vld1,
              startOutS => startOutS,
              endOutS => endOutS
              );
  ...
  dataIn_1_cast_re <= dataIn_re_signed;
  dataIn_1_cast_im <= dataIn_im_signed;
  ...
  intdelay_reg_next(0) <= dataIn_1_cast_re;
  ...
  intdelay_reg_next_1(0) <= dataIn_1_cast_im;
  ...
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_16(0) <= to_signed(16#0000000#, 26);
      intdelay_reg_16(1) <= to_signed(16#0000000#, 26);
      intdelay_reg_16(2) <= to_signed(16#0000000#, 26);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF syncReset = '1' THEN
        intdelay_reg_16(0) <= to_signed(16#0000000#, 26);
        intdelay_reg_16(1) <= to_signed(16#0000000#, 26);
  ...
  din_11_re_dly <= intdelay_reg_16(2);
  intdelay_reg_next_16(0) <= dout_10_1_re_signed;
  intdelay_reg_next_16(1) <= intdelay_reg_16(0);
  intdelay_reg_next_16(2) <= intdelay_reg_16(1);

  intdelay_17_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_17(0) <= to_signed(16#0000000#, 26);
      intdelay_reg_17(1) <= to_signed(16#0000000#, 26);
      intdelay_reg_17(2) <= to_signed(16#0000000#, 26);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF syncReset = '1' THEN
        intdelay_reg_17(0) <= to_signed(16#0000000#, 26);
        intdelay_reg_17(1) <= to_signed(16#0000000#, 26);
  ...
  din_11_im_dly <= intdelay_reg_17(2);
  intdelay_reg_next_17(0) <= dout_10_1_im_signed;
  intdelay_reg_next_17(1) <= intdelay_reg_17(0);
  intdelay_reg_next_17(2) <= intdelay_reg_17(1);
  ...
  din_11_vld_dly <= intdelay_reg_18(2);
  intdelay_reg_next_18(0) <= dout_10_1_vld;
  intdelay_reg_next_18(1) <= intdelay_reg_18(0);
  intdelay_reg_next_18(2) <= intdelay_reg_18(1);
