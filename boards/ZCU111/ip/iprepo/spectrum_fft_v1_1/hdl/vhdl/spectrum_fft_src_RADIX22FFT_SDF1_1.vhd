-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_SDF1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_SDF1_1
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_SDF1_1 IS
...
END spectrum_fft_src_RADIX22FFT_SDF1_1;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_SDF1_1 IS
  ...
  COMPONENT spectrum_fft_src_SDFCommutator1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : spectrum_fft_src_SDFCommutator1
    USE ENTITY work.spectrum_fft_src_SDFCommutator1(rtl);
...
BEGIN
  u_dataMEM_im_0_1 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_1_generic : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 10,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_1 : spectrum_fft_src_SDFCommutator1
    PORT MAP( clk => clk,
              reset => reset,
