-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_Complex4Multiply_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_Complex4Multiply_block2
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_9/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_Complex4Multiply_block2 IS
...
END spectrum_fft_src_Complex4Multiply_block2;


ARCHITECTURE rtl OF spectrum_fft_src_Complex4Multiply_block2 IS
  ...
  SIGNAL Complex4Multiply_din1_re_pipe1   : signed(24 DOWNTO 0) := to_signed(16#0000000#, 25);  -- sfix25
  SIGNAL Complex4Multiply_din1_im_pipe1   : signed(24 DOWNTO 0) := to_signed(16#0000000#, 25);  -- sfix25
  SIGNAL Complex4Multiply_mult1_re_pipe1  : signed(40 DOWNTO 0) := to_signed(0, 41);  -- sfix41
  SIGNAL Complex4Multiply_mult2_re_pipe1  : signed(40 DOWNTO 0) := to_signed(0, 41);  -- sfix41
  SIGNAL Complex4Multiply_mult1_im_pipe1  : signed(40 DOWNTO 0) := to_signed(0, 41);  -- sfix41
  SIGNAL Complex4Multiply_mult2_im_pipe1  : signed(40 DOWNTO 0) := to_signed(0, 41);  -- sfix41
  ...
  SIGNAL prod1_re                         : signed(40 DOWNTO 0) := to_signed(0, 41);  -- sfix41_En29
  SIGNAL prod1_im                         : signed(40 DOWNTO 0) := to_signed(0, 41);  -- sfix41_En29
  SIGNAL prod2_re                         : signed(40 DOWNTO 0) := to_signed(0, 41);  -- sfix41_En29
  SIGNAL prod2_im                         : signed(40 DOWNTO 0) := to_signed(0, 41);  -- sfix41_En29
  SIGNAL din_vld_dly1                     : std_logic;
  SIGNAL din_vld_dly2                     : std_logic;
  SIGNAL din_vld_dly3                     : std_logic;
  SIGNAL prod_vld                         : std_logic;
  SIGNAL Complex4Add_multRes_re_reg       : signed(41 DOWNTO 0);  -- sfix42
  SIGNAL Complex4Add_multRes_im_reg       : signed(41 DOWNTO 0);  -- sfix42
  SIGNAL Complex4Add_prod_vld_reg1        : std_logic;
  SIGNAL Complex4Add_prod1_re_reg         : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL Complex4Add_prod1_im_reg         : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL Complex4Add_prod2_re_reg         : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL Complex4Add_prod2_im_reg         : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(41 DOWNTO 0);  -- sfix42_En29
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(41 DOWNTO 0);  -- sfix42_En29
  SIGNAL Complex4Add_sub_cast             : signed(41 DOWNTO 0);  -- sfix42_En29
  SIGNAL Complex4Add_sub_cast_1           : signed(41 DOWNTO 0);  -- sfix42_En29
  SIGNAL Complex4Add_add_cast             : signed(41 DOWNTO 0);  -- sfix42_En29
  SIGNAL Complex4Add_add_cast_1           : signed(41 DOWNTO 0);  -- sfix42_En29
  SIGNAL mulResFP_re                      : signed(41 DOWNTO 0);  -- sfix42_En29
  SIGNAL mulResFP_im                      : signed(41 DOWNTO 0);  -- sfix42_En29
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Complex4Add_multRes_re_reg <= to_signed(0, 42);
      Complex4Add_multRes_im_reg <= to_signed(0, 42);
      Complex4Add_prod1_re_reg <= to_signed(0, 41);
      Complex4Add_prod1_im_reg <= to_signed(0, 41);
      Complex4Add_prod2_re_reg <= to_signed(0, 41);
      Complex4Add_prod2_im_reg <= to_signed(0, 41);
  ...
  Complex4Add_sub_cast <= resize(Complex4Add_prod1_re_reg, 42);
  Complex4Add_sub_cast_1 <= resize(Complex4Add_prod2_re_reg, 42);
  Complex4Add_multRes_re_reg_next <= Complex4Add_sub_cast - Complex4Add_sub_cast_1;
  Complex4Add_add_cast <= resize(Complex4Add_prod1_im_reg, 42);
  Complex4Add_add_cast_1 <= resize(Complex4Add_prod2_im_reg, 42);
  ...
  dinXTwdl_re_tmp <= mulResFP_re(38 DOWNTO 14);

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= mulResFP_im(38 DOWNTO 14);
