-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_nfp_convert_sfix_27_En15_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_nfp_convert_sfix_27_En15_to_single
-- Source Path: spectrum_fft_hdlcoder/FFT/nfp_convert_sfix_27_En15_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY spectrum_fft_src_nfp_convert_sfix_27_En15_to_single IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        nfp_in                            :   IN    std_logic_vector(26 DOWNTO 0);  -- sfix27_En15
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END spectrum_fft_src_nfp_convert_sfix_27_En15_to_single;


ARCHITECTURE rtl OF spectrum_fft_src_nfp_convert_sfix_27_En15_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(26 DOWNTO 0);  -- sfix27_En15
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(26 DOWNTO 0);  -- ufix27_En15
  SIGNAL Unary_Minus_cast                 : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL Unary_Minus_cast_1               : signed(27 DOWNTO 0);  -- sfix28_En15
  SIGNAL Unary_Minus_out1                 : signed(26 DOWNTO 0);  -- sfix27_En15
  SIGNAL Unary_Minus_out1_dtc             : unsigned(26 DOWNTO 0);  -- ufix27_En15
  SIGNAL Switch_out1                      : unsigned(26 DOWNTO 0);  -- ufix27_En15
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(16#0000000#, 27) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(16#0000000#, 27) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 28);
