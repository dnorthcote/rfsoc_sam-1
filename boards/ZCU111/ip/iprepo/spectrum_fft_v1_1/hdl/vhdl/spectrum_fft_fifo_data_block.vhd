-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_fifo_data_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_fifo_data_block
-- Source Path: spectrum_fft/spectrum_fft_axi4_stream_imag_slave/spectrum_fft_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_fifo_data_block IS
...
END spectrum_fft_fifo_data_block;


ARCHITECTURE rtl OF spectrum_fft_fifo_data_block IS
...
BEGIN
  ...
  u_spectrum_fft_fifo_data_classic_ram : spectrum_fft_SimpleDualPortRAM_generic
