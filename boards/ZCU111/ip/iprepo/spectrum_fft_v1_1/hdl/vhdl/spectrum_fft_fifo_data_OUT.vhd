-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_fifo_data_OUT
-- Source Path: spectrum_fft/spectrum_fft_axi4_stream_master/spectrum_fft_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_fifo_data_OUT IS
...
END spectrum_fft_fifo_data_OUT;


ARCHITECTURE rtl OF spectrum_fft_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT spectrum_fft_SimpleDualPortRAM_generic
  ...
  FOR ALL : spectrum_fft_SimpleDualPortRAM_generic
    USE ENTITY work.spectrum_fft_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_spectrum_fft_fifo_data_OUT_classic_ram_generic : spectrum_fft_SimpleDualPortRAM_generic
