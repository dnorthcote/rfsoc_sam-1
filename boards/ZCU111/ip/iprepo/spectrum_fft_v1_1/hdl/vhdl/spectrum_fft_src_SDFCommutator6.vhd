-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_SDFCommutator6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_SDFCommutator6
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF2_6/SDFCommutator6
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_SDFCommutator6 IS
...
END spectrum_fft_src_SDFCommutator6;


ARCHITECTURE rtl OF spectrum_fft_src_SDFCommutator6 IS
  ...
  SIGNAL SDFCummutator_out_re             : signed(21 DOWNTO 0);  -- sfix22
  SIGNAL SDFCummutator_out_im             : signed(21 DOWNTO 0);  -- sfix22
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(21 DOWNTO 0);  -- sfix22
  SIGNAL SDFCummutator_wrData_im_reg      : signed(21 DOWNTO 0);  -- sfix22
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(21 DOWNTO 0);  -- sfix22
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(21 DOWNTO 0);  -- sfix22
  ...
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(21 DOWNTO 0);  -- sfix22
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(21 DOWNTO 0);  -- sfix22
...
BEGIN
  u_dataXMEM_re_0_6 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_6 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 22
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        ...
        IF ((SDFCummutator_wrEnb_xmem AND hdlcoder_to_stdlogic(SDFCummutator_wrAddr_reg = to_unsigned(16#17#, 5))) AND SDFCummutator_wrEnb_reg) = '1' THEN 
    ...
    CASE SDFCummutator_mem_btf_switch IS
      ...
      WHEN "01" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
        SDFCummutator_rdEnb_xmem_next <= '0';
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#1F#, 5)) AND btfout_vld) = '1' THEN 
      ...
      WHEN "10" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#2#, 2);
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#17#, 5)) AND xf_vld) = '1' THEN 
          SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
