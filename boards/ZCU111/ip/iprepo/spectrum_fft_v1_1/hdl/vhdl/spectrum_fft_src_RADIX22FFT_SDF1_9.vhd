-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_SDF1_9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_SDF1_9
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_9
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_SDF1_9 IS
...
END spectrum_fft_src_RADIX22FFT_SDF1_9;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_SDF1_9 IS

  -- Component Declarations
  COMPONENT spectrum_fft_src_Complex4Multiply_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_SDFCommutator9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          din_9_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : spectrum_fft_src_Complex4Multiply_block2
    USE ENTITY work.spectrum_fft_src_Complex4Multiply_block2(rtl);

  FOR ALL : spectrum_fft_src_SimpleDualPortRAM_generic
    USE ENTITY work.spectrum_fft_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : spectrum_fft_src_SDFCommutator9
    USE ENTITY work.spectrum_fft_src_SDFCommutator9(rtl);
...
BEGIN
  u_MUL4 : spectrum_fft_src_Complex4Multiply_block2
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_9 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_9 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 25
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_9 : spectrum_fft_src_SDFCommutator9
    PORT MAP( clk => clk,
              reset => reset,
              din_9_vld_dly => din_9_vld_dly,
