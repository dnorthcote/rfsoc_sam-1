-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_SDF1_11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_SDF1_11
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_11
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_SDF1_11 IS
...
END spectrum_fft_src_RADIX22FFT_SDF1_11;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_SDF1_11 IS

  -- Component Declarations
  COMPONENT spectrum_fft_src_Complex4Multiply_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_SDFCommutator11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          din_11_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : spectrum_fft_src_Complex4Multiply_block3
    USE ENTITY work.spectrum_fft_src_Complex4Multiply_block3(rtl);

  FOR ALL : spectrum_fft_src_SDFCommutator11
    USE ENTITY work.spectrum_fft_src_SDFCommutator11(rtl);
...
BEGIN
  u_MUL4 : spectrum_fft_src_Complex4Multiply_block3
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_11 : spectrum_fft_src_SDFCommutator11
    PORT MAP( clk => clk,
              reset => reset,
              din_11_vld_dly => din_11_vld_dly,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_11_re => dout_11_re_tmp,  -- sfix27_En15
              dout_11_im => dout_11_im_tmp,  -- sfix27_En15
