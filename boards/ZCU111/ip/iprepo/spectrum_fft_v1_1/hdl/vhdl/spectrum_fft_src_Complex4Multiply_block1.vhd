-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_Complex4Multiply_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_Complex4Multiply_block1
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_7/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_Complex4Multiply_block1 IS
...
END spectrum_fft_src_Complex4Multiply_block1;


ARCHITECTURE rtl OF spectrum_fft_src_Complex4Multiply_block1 IS
...
BEGIN
  ...
  dinXTwdl_re_tmp <= mulResFP_re(36 DOWNTO 14);

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= mulResFP_im(36 DOWNTO 14);
