-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_SDF2_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_SDF2_2
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF2_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_SDF2_2 IS
...
END spectrum_fft_src_RADIX22FFT_SDF2_2;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT spectrum_fft_src_SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : spectrum_fft_src_SDFCommutator2
    USE ENTITY work.spectrum_fft_src_SDFCommutator2(rtl);
...
BEGIN
  u_dataMEM_im_0_2 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_2 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 9,
                 DataWidth => 18
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_2 : spectrum_fft_src_SDFCommutator2
    PORT MAP( clk => clk,
              reset => reset,
