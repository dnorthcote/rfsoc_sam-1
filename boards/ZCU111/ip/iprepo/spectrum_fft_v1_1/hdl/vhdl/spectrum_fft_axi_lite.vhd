-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_axi_lite
-- Source Path: spectrum_fft/spectrum_fft_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_axi_lite IS
...
END spectrum_fft_axi_lite;


ARCHITECTURE rtl OF spectrum_fft_axi_lite IS

  -- Component Declarations
  COMPONENT spectrum_fft_addr_decoder
  ...
  COMPONENT spectrum_fft_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : spectrum_fft_addr_decoder
    USE ENTITY work.spectrum_fft_addr_decoder(rtl);

  FOR ALL : spectrum_fft_axi_lite_module
    USE ENTITY work.spectrum_fft_axi_lite_module(rtl);
...
BEGIN
  u_spectrum_fft_addr_decoder_inst : spectrum_fft_addr_decoder
  ...
  u_spectrum_fft_axi_lite_module_inst : spectrum_fft_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
