-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_SDFCommutator9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_SDFCommutator9
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_9/SDFCommutator9
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_SDFCommutator9 IS
...
END spectrum_fft_src_SDFCommutator9;


ARCHITECTURE rtl OF spectrum_fft_src_SDFCommutator9 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL xf_im_signed                     : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL dinXTwdlf_re_signed              : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL dinXTwdlf_im_signed              : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL btf1_re_signed                   : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL btf1_im_signed                   : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL btf2_re_signed                   : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL btf2_im_signed                   : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL SDFCummutator_out_re             : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL SDFCummutator_out_im             : signed(24 DOWNTO 0);  -- sfix25
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL SDFCummutator_wrData_im_reg      : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(24 DOWNTO 0);  -- sfix25
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL SDFCummutator_out_im_next        : signed(24 DOWNTO 0);  -- sfix25_En15
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En15
  ...
  SIGNAL wrData_re_tmp                    : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL wrData_im_tmp                    : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL wrAddr_tmp                       : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL xData_re                         : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL xData_im                         : signed(24 DOWNTO 0);  -- sfix25_En15
  ...
  SIGNAL dout0_re                         : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL dout0_im                         : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL xX_re_signed                     : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL xX_im                            : std_logic_vector(24 DOWNTO 0);  -- ufix25
  SIGNAL xX_im_signed                     : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(24 DOWNTO 0);  -- sfix25
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_9_1_re_tmp                  : signed(24 DOWNTO 0);  -- sfix25_En15
  SIGNAL dout_9_1_im_tmp                  : signed(24 DOWNTO 0);  -- sfix25_En15

BEGIN
  u_dataXMEM_re_0_9 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_9 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 25
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      SDFCummutator_out_re <= to_signed(16#0000000#, 25);
      SDFCummutator_out_im <= to_signed(16#0000000#, 25);
      SDFCummutator_wrData_re_reg <= to_signed(16#0000000#, 25);
      SDFCummutator_wrData_im_reg <= to_signed(16#0000000#, 25);
      ...
      SDFCummutator_wrXData_re_reg <= to_signed(16#0000000#, 25);
      SDFCummutator_wrXData_im_reg <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        SDFCummutator_wrXData_re_reg_next <= to_signed(16#0000000#, 25);
        SDFCummutator_wrXData_im_reg_next <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    IF reset = '1' THEN
      SDFOutmux_btf2Pipe_re <= to_signed(16#0000000#, 25);
      SDFOutmux_btf2Pipe_im <= to_signed(16#0000000#, 25);
  ...
  BEGIN
    ...
    END IF;
    dout_9_1_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_9_1_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_9_1_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_9_1_re <= std_logic_vector(dout_9_1_re_tmp);

  dout_9_1_im <= std_logic_vector(dout_9_1_im_tmp);
