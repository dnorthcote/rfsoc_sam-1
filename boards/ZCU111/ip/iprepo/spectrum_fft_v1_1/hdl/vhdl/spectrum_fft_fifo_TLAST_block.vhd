-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_fifo_TLAST_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_fifo_TLAST_block
-- Source Path: spectrum_fft/spectrum_fft_axi4_stream_imag_slave/spectrum_fft_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_fifo_TLAST_block IS
...
END spectrum_fft_fifo_TLAST_block;


ARCHITECTURE rtl OF spectrum_fft_fifo_TLAST_block IS
...
BEGIN
  ...
  u_spectrum_fft_fifo_TLAST_classic_ram : spectrum_fft_SimpleDualPortRAM_singlebit
