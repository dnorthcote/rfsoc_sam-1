-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_fifo_TLAST_OUT
-- Source Path: spectrum_fft/spectrum_fft_axi4_stream_master/spectrum_fft_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_fifo_TLAST_OUT IS
...
END spectrum_fft_fifo_TLAST_OUT;


ARCHITECTURE rtl OF spectrum_fft_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT spectrum_fft_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : spectrum_fft_SimpleDualPortRAM_singlebit
    USE ENTITY work.spectrum_fft_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_spectrum_fft_fifo_TLAST_OUT_classic_ram_singlebit : spectrum_fft_SimpleDualPortRAM_singlebit
