-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_SDFCommutator10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_SDFCommutator10
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF2_10/SDFCommutator10
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_SDFCommutator10 IS
...
END spectrum_fft_src_SDFCommutator10;


ARCHITECTURE rtl OF spectrum_fft_src_SDFCommutator10 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL xf_im_signed                     : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL dinf_re_signed                   : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL dinf_im_signed                   : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL btf1_re_signed                   : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL btf1_im_signed                   : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL btf2_re_signed                   : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL btf2_im_signed                   : signed(25 DOWNTO 0);  -- sfix26_En15
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL SDFCummutator_out_im_next        : signed(25 DOWNTO 0);  -- sfix26_En15
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(25 DOWNTO 0);  -- sfix26_En15
  ...
  SIGNAL wrData_re_tmp                    : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL wrData_im_tmp                    : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL xData_re                         : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL xData_im                         : signed(25 DOWNTO 0);  -- sfix26_En15
  ...
  SIGNAL dout0_re                         : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL dout0_im                         : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL xX_re_signed                     : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL xX_im                            : std_logic_vector(25 DOWNTO 0);  -- ufix26
  SIGNAL xX_im_signed                     : signed(25 DOWNTO 0);  -- sfix26_En15
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_10_1_re_tmp                 : signed(25 DOWNTO 0);  -- sfix26_En15
  SIGNAL dout_10_1_im_tmp                 : signed(25 DOWNTO 0);  -- sfix26_En15

BEGIN
  u_dataXMEM_re_0_10 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_10 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 26
                 )
    PORT MAP( clk => clk,
