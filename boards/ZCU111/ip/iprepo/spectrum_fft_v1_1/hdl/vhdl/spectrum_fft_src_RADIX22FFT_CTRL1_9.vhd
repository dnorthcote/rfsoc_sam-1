-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_CTRL1_9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_CTRL1_9
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_CTRL1_9
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_CTRL1_9 IS
...
END spectrum_fft_src_RADIX22FFT_CTRL1_9;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_CTRL1_9 IS
  ...
  SIGNAL rd_9_Addr_tmp                    : unsigned(1 DOWNTO 0);  -- ufix2
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_9_Enb <= '0';
        IF (dinXTwdl_9_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3#, 2))) = '1' THEN 
