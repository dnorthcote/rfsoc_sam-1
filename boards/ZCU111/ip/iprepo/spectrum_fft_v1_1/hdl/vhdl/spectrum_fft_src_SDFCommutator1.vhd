-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_SDFCommutator1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_SDFCommutator1
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_1/SDFCommutator1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_SDFCommutator1 IS
...
END spectrum_fft_src_SDFCommutator1;


ARCHITECTURE rtl OF spectrum_fft_src_SDFCommutator1 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL xf_im_signed                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL dinXTwdlf_re_signed              : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL dinXTwdlf_im_signed              : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL btf1_re_signed                   : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL btf1_im_signed                   : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL btf2_re_signed                   : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL btf2_im_signed                   : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL SDFCummutator_out_re             : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFCummutator_out_im             : signed(16 DOWNTO 0);  -- sfix17
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFCummutator_wrData_im_reg      : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(16 DOWNTO 0);  -- sfix17
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL SDFCummutator_out_im_next        : signed(16 DOWNTO 0);  -- sfix17_En15
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(16 DOWNTO 0);  -- sfix17_En15
  ...
  SIGNAL wrData_re_tmp                    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL wrData_im_tmp                    : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL wrAddr_tmp                       : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL xData_re                         : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL xData_im                         : signed(16 DOWNTO 0);  -- sfix17_En15
  ...
  SIGNAL dout0_re                         : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL dout0_im                         : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL xX_re_signed                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL xX_im                            : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL xX_im_signed                     : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_1_1_re_tmp                  : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL dout_1_1_im_tmp                  : signed(16 DOWNTO 0);  -- sfix17_En15

BEGIN
  u_dataXMEM_re_0_1 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_1 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      SDFCummutator_out_re <= to_signed(16#00000#, 17);
      SDFCummutator_out_im <= to_signed(16#00000#, 17);
      SDFCummutator_wrData_re_reg <= to_signed(16#00000#, 17);
      SDFCummutator_wrData_im_reg <= to_signed(16#00000#, 17);
      ...
      SDFCummutator_wrXData_re_reg <= to_signed(16#00000#, 17);
      SDFCummutator_wrXData_im_reg <= to_signed(16#00000#, 17);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        SDFCummutator_wrXData_re_reg_next <= to_signed(16#00000#, 17);
        SDFCummutator_wrXData_im_reg_next <= to_signed(16#00000#, 17);
        ...
        IF ((SDFCummutator_wrEnb_xmem AND hdlcoder_to_stdlogic(SDFCummutator_wrAddr_reg = to_unsigned(16#3F7#, 10))) AND SDFCummutator_wrEnb_reg) = '1' THEN 
    ...
    CASE SDFCummutator_mem_btf_switch IS
      ...
      WHEN "01" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
        SDFCummutator_rdEnb_xmem_next <= '0';
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#3FF#, 10)) AND btf_vld) = '1' THEN 
      ...
      WHEN "10" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#2#, 2);
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#3F7#, 10)) AND xf_vld) = '1' THEN 
          SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
  ...
  BEGIN
    IF reset = '1' THEN
      SDFOutmux_btf2Pipe_re <= to_signed(16#00000#, 17);
      SDFOutmux_btf2Pipe_im <= to_signed(16#00000#, 17);
  ...
  BEGIN
    ...
    END IF;
    dout_1_1_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_1_1_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_1_1_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_1_1_re <= std_logic_vector(dout_1_1_re_tmp);

  dout_1_1_im <= std_logic_vector(dout_1_1_im_tmp);
