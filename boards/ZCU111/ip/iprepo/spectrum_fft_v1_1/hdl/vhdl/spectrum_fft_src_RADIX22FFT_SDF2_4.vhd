-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_SDF2_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_SDF2_4
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF2_4
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_SDF2_4 IS
...
END spectrum_fft_src_RADIX22FFT_SDF2_4;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_SDF2_4 IS
  ...
  COMPONENT spectrum_fft_src_SDFCommutator4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : spectrum_fft_src_SDFCommutator4
    USE ENTITY work.spectrum_fft_src_SDFCommutator4(rtl);
...
BEGIN
  u_dataMEM_im_0_4 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_4 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 7,
                 DataWidth => 20
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_4 : spectrum_fft_src_SDFCommutator4
    PORT MAP( clk => clk,
              reset => reset,
