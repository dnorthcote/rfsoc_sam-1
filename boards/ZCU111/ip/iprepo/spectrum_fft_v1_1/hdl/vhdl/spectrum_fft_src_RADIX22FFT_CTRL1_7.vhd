-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_CTRL1_7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_CTRL1_7
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_CTRL1_7
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_CTRL1_7 IS
...
END spectrum_fft_src_RADIX22FFT_CTRL1_7;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_CTRL1_7 IS
  ...
  SIGNAL rd_7_Addr_tmp                    : unsigned(3 DOWNTO 0);  -- ufix4
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_7_Enb <= '0';
        IF (dinXTwdl_7_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#F#, 4))) = '1' THEN 
