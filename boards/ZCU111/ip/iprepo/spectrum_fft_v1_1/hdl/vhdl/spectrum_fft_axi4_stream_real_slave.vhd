-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_axi4_stream_real_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_axi4_stream_real_slave
-- Source Path: spectrum_fft/spectrum_fft_axi4_stream_real_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_axi4_stream_real_slave IS
...
END spectrum_fft_axi4_stream_real_slave;


ARCHITECTURE rtl OF spectrum_fft_axi4_stream_real_slave IS

  -- Component Declarations
  COMPONENT spectrum_fft_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_fifo_TLAST
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_fifo_TUSER
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : spectrum_fft_fifo_data
    USE ENTITY work.spectrum_fft_fifo_data(rtl);

  FOR ALL : spectrum_fft_fifo_TLAST
    USE ENTITY work.spectrum_fft_fifo_TLAST(rtl);

  FOR ALL : spectrum_fft_fifo_TUSER
    USE ENTITY work.spectrum_fft_fifo_TUSER(rtl);
...
BEGIN
  u_spectrum_fft_fifo_data_inst : spectrum_fft_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_spectrum_fft_fifo_TLAST_inst : spectrum_fft_fifo_TLAST
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_spectrum_fft_fifo_TUSER_inst : spectrum_fft_fifo_TUSER
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
