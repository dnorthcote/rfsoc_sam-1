-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_SDF2_10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_SDF2_10
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF2_10
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_SDF2_10 IS
...
END spectrum_fft_src_RADIX22FFT_SDF2_10;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_SDF2_10 IS

  -- Component Declarations
  COMPONENT spectrum_fft_src_SDFCommutator10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : spectrum_fft_src_SDFCommutator10
    USE ENTITY work.spectrum_fft_src_SDFCommutator10(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_10 : spectrum_fft_src_SDFCommutator10
    PORT MAP( clk => clk,
              reset => reset,
