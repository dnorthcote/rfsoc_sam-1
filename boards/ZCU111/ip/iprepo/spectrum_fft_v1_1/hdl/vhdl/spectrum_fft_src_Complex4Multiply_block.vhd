-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_Complex4Multiply_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_Complex4Multiply_block
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_5/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_Complex4Multiply_block IS
...
END spectrum_fft_src_Complex4Multiply_block;


ARCHITECTURE rtl OF spectrum_fft_src_Complex4Multiply_block IS

  -- Signals
  SIGNAL din_re_signed                    : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL din_re_reg                       : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL din_im_signed                    : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL din_im_reg                       : signed(20 DOWNTO 0);  -- sfix21_En15
  ...
  SIGNAL Complex4Multiply_din1_re_pipe1   : signed(20 DOWNTO 0) := to_signed(16#000000#, 21);  -- sfix21
  SIGNAL Complex4Multiply_din1_im_pipe1   : signed(20 DOWNTO 0) := to_signed(16#000000#, 21);  -- sfix21
  ...
  SIGNAL prod1_re                         : signed(36 DOWNTO 0) := to_signed(0, 37);  -- sfix37_En29
  SIGNAL prod1_im                         : signed(36 DOWNTO 0) := to_signed(0, 37);  -- sfix37_En29
  SIGNAL prod2_re                         : signed(36 DOWNTO 0) := to_signed(0, 37);  -- sfix37_En29
  SIGNAL prod2_im                         : signed(36 DOWNTO 0) := to_signed(0, 37);  -- sfix37_En29
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex4Add_sub_cast             : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex4Add_sub_cast_1           : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex4Add_add_cast             : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex4Add_add_cast_1           : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL mulResFP_re                      : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL mulResFP_im                      : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL dinXTwdl_re_tmp                  : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL dinXTwdl_im_tmp                  : signed(20 DOWNTO 0);  -- sfix21_En15
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      din_re_reg <= to_signed(16#000000#, 21);
  ...
  BEGIN
    IF reset = '1' THEN
      din_im_reg <= to_signed(16#000000#, 21);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF syncReset = '1' THEN
        din_im_reg <= to_signed(16#000000#, 21);
      ELSE 
  ...
  dinXTwdl_re_tmp <= mulResFP_re(34 DOWNTO 14);

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= mulResFP_im(34 DOWNTO 14);
