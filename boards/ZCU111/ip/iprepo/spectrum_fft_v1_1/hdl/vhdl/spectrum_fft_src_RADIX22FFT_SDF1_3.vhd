-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_SDF1_3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_SDF1_3
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_SDF1_3 IS
...
END spectrum_fft_src_RADIX22FFT_SDF1_3;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_SDF1_3 IS

  -- Component Declarations
  COMPONENT spectrum_fft_src_Complex4Multiply
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_SDFCommutator3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          din_3_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : spectrum_fft_src_Complex4Multiply
    USE ENTITY work.spectrum_fft_src_Complex4Multiply(rtl);

  FOR ALL : spectrum_fft_src_SimpleDualPortRAM_generic
    USE ENTITY work.spectrum_fft_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : spectrum_fft_src_SDFCommutator3
    USE ENTITY work.spectrum_fft_src_SDFCommutator3(rtl);
...
BEGIN
  u_MUL4 : spectrum_fft_src_Complex4Multiply
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_3 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_3 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 8,
                 DataWidth => 19
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_3 : spectrum_fft_src_SDFCommutator3
    PORT MAP( clk => clk,
              reset => reset,
              din_3_vld_dly => din_3_vld_dly,
