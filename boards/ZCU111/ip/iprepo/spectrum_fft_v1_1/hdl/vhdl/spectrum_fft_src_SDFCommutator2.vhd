-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_SDFCommutator2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_SDFCommutator2
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF2_2/SDFCommutator2
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_SDFCommutator2 IS
...
END spectrum_fft_src_SDFCommutator2;


ARCHITECTURE rtl OF spectrum_fft_src_SDFCommutator2 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL xf_im_signed                     : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL dinf_re_signed                   : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL dinf_im_signed                   : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL btf1_re_signed                   : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL btf1_im_signed                   : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL btf2_re_signed                   : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL btf2_im_signed                   : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL SDFCummutator_out_re             : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL SDFCummutator_out_im             : signed(17 DOWNTO 0);  -- sfix18
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL SDFCummutator_wrData_im_reg      : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(17 DOWNTO 0);  -- sfix18
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL SDFCummutator_out_im_next        : signed(17 DOWNTO 0);  -- sfix18_En15
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(17 DOWNTO 0);  -- sfix18_En15
  ...
  SIGNAL wrData_re_tmp                    : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL wrData_im_tmp                    : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL wrAddr_tmp                       : unsigned(8 DOWNTO 0);  -- ufix9
  SIGNAL xData_re                         : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL xData_im                         : signed(17 DOWNTO 0);  -- sfix18_En15
  ...
  SIGNAL dout0_re                         : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL dout0_im                         : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL xX_re_signed                     : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL xX_im                            : std_logic_vector(17 DOWNTO 0);  -- ufix18
  SIGNAL xX_im_signed                     : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(17 DOWNTO 0);  -- sfix18
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_2_1_re_tmp                  : signed(17 DOWNTO 0);  -- sfix18_En15
  SIGNAL dout_2_1_im_tmp                  : signed(17 DOWNTO 0);  -- sfix18_En15

BEGIN
  u_dataXMEM_re_0_2 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_2 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 18
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      SDFCummutator_out_re <= to_signed(16#00000#, 18);
      SDFCummutator_out_im <= to_signed(16#00000#, 18);
      SDFCummutator_wrData_re_reg <= to_signed(16#00000#, 18);
      SDFCummutator_wrData_im_reg <= to_signed(16#00000#, 18);
      ...
      SDFCummutator_wrXData_re_reg <= to_signed(16#00000#, 18);
      SDFCummutator_wrXData_im_reg <= to_signed(16#00000#, 18);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        SDFCummutator_wrXData_re_reg_next <= to_signed(16#00000#, 18);
        SDFCummutator_wrXData_im_reg_next <= to_signed(16#00000#, 18);
    ...
    CASE SDFCummutator_mem_btf_switch IS
      ...
      WHEN "01" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
        SDFCummutator_rdEnb_xmem_next <= '0';
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#1FF#, 9)) AND btfout_vld) = '1' THEN 
  ...
  BEGIN
    IF reset = '1' THEN
      SDFOutmux_btf2Pipe_re <= to_signed(16#00000#, 18);
      SDFOutmux_btf2Pipe_im <= to_signed(16#00000#, 18);
  ...
  BEGIN
    ...
    END IF;
    dout_2_1_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_2_1_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_2_1_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_2_1_re <= std_logic_vector(dout_2_1_re_tmp);

  dout_2_1_im <= std_logic_vector(dout_2_1_im_tmp);
