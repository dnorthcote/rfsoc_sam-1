-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft.vhd
...
ARCHITECTURE rtl OF spectrum_fft IS

  -- Component Declarations
  COMPONENT spectrum_fft_axi_lite
  ...
  COMPONENT spectrum_fft_reset_sync
  ...
  COMPONENT spectrum_fft_axi4_stream_imag_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Imag_Slave_TDATA    :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  COMPONENT spectrum_fft_axi4_stream_real_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Real_Slave_TDATA    :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  COMPONENT spectrum_fft_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : spectrum_fft_axi_lite
    USE ENTITY work.spectrum_fft_axi_lite(rtl);

  FOR ALL : spectrum_fft_reset_sync
    USE ENTITY work.spectrum_fft_reset_sync(rtl);

  FOR ALL : spectrum_fft_axi4_stream_imag_slave
    USE ENTITY work.spectrum_fft_axi4_stream_imag_slave(rtl);

  FOR ALL : spectrum_fft_axi4_stream_real_slave
    USE ENTITY work.spectrum_fft_axi4_stream_real_slave(rtl);

  FOR ALL : spectrum_fft_dut
    USE ENTITY work.spectrum_fft_dut(rtl);

  FOR ALL : spectrum_fft_axi4_stream_master
    USE ENTITY work.spectrum_fft_axi4_stream_master(rtl);
  ...
  SIGNAL s_axis_im_tuser_sig              : std_logic;  -- ufix1
  SIGNAL top_user_TLAST_1                 : std_logic;  -- ufix1
  SIGNAL s_axis_im_tlast_sig              : std_logic;  -- ufix1
  ...
  SIGNAL top_user_TUSER_2                 : std_logic;  -- ufix1
  SIGNAL s_axis_re_tuser_sig              : std_logic;  -- ufix1
  SIGNAL top_user_TLAST_2                 : std_logic;  -- ufix1
  SIGNAL s_axis_re_tlast_sig              : std_logic;  -- ufix1
...
BEGIN
  u_spectrum_fft_axi_lite_inst : spectrum_fft_axi_lite
  ...
  u_spectrum_fft_reset_sync_inst : spectrum_fft_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_spectrum_fft_axi4_stream_imag_slave_inst : spectrum_fft_axi4_stream_imag_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1,
  ...
  u_spectrum_fft_axi4_stream_real_slave_inst : spectrum_fft_axi4_stream_real_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1,
              ...
              user_TLAST => top_user_TLAST_2,  -- ufix1
              user_TUSER => top_user_TUSER_2  -- ufix1
              );

  u_spectrum_fft_dut_inst : spectrum_fft_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              s_axis_re_tvalid => s_axis_re_tvalid_sig,  -- ufix1
              s_axis_re_tdata => top_user_data_1,  -- ufix16
              s_axis_re_tlast => s_axis_re_tlast_sig,  -- ufix1
              s_axis_re_tuser => s_axis_re_tuser_sig,  -- ufix1
              s_axis_im_tvalid => s_axis_im_tvalid_sig,  -- ufix1
              s_axis_im_tdata => top_user_data,  -- ufix16
              s_axis_im_tlast => s_axis_im_tlast_sig,  -- ufix1
              s_axis_im_tuser => s_axis_im_tuser_sig,  -- ufix1
  ...
  u_spectrum_fft_axi4_stream_master_inst : spectrum_fft_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1,
  ...
  ip_timestamp <= to_unsigned(2010152209, 32);
  ...
  s_axis_im_tuser_sig <= top_user_TUSER_1;

  s_axis_im_tlast_sig <= top_user_TLAST_1;

  top_user_ready_1 <= s_axis_im_tready_sig;

  s_axis_im_tvalid_sig <= top_user_valid_1;

  s_axis_re_tuser_sig <= top_user_TUSER_2;

  s_axis_re_tlast_sig <= top_user_TLAST_2;

  top_user_ready_2 <= s_axis_re_tready_sig;

  s_axis_re_tvalid_sig <= top_user_valid_2;
