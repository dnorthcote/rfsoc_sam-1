-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_TWDLROM_9_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_TWDLROM_9_1
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/TWDLROM_9_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_TWDLROM_9_1 IS
...
END spectrum_fft_src_TWDLROM_9_1;


ARCHITECTURE rtl OF spectrum_fft_src_TWDLROM_9_1 IS
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF (dout_8_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#1BF#, 9))) = '1' THEN 
      Radix22TwdlMapping_phase_next <= Radix22TwdlMapping_phase + to_unsigned(16#1#, 2);
    END IF;
    IF dout_8_1_vld = '1' THEN 
      Radix22TwdlMapping_cnt_next <= Radix22TwdlMapping_cnt + to_unsigned(16#040#, 9);
    END IF;
