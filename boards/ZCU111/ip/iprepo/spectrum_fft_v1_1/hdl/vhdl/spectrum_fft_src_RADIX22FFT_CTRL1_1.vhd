-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_CTRL1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_CTRL1_1
...
ENTITY spectrum_fft_src_RADIX22FFT_CTRL1_1 IS
...
END spectrum_fft_src_RADIX22FFT_CTRL1_1;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_CTRL1_1 IS
  ...
  SIGNAL rd_1_Addr_tmp                    : unsigned(9 DOWNTO 0);  -- ufix10
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_1_Enb <= '0';
        IF (dinXTwdl_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3FF#, 10))) = '1' THEN 
