-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_fifo_TUSER_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_fifo_TUSER_OUT
-- Source Path: spectrum_fft/spectrum_fft_axi4_stream_master/spectrum_fft_fifo_TUSER_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_fifo_TUSER_OUT IS
...
END spectrum_fft_fifo_TUSER_OUT;


ARCHITECTURE rtl OF spectrum_fft_fifo_TUSER_OUT IS
...
BEGIN
  ...
  u_spectrum_fft_fifo_TUSER_OUT_classic_ram : spectrum_fft_SimpleDualPortRAM_singlebit
