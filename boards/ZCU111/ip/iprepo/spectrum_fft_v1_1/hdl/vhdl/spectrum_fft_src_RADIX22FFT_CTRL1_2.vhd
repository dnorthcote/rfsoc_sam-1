-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_CTRL1_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_CTRL1_2
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_CTRL1_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_CTRL1_2 IS
...
END spectrum_fft_src_RADIX22FFT_CTRL1_2;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_CTRL1_2 IS
  ...
  SIGNAL rd_2_Addr_tmp                    : unsigned(8 DOWNTO 0);  -- ufix9
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_2_Enb <= '0';
        IF (dout_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#1FF#, 9))) = '1' THEN 
