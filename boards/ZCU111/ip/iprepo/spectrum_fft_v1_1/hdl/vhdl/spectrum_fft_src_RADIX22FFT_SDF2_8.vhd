-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_SDF2_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_SDF2_8
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF2_8
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_SDF2_8 IS
...
END spectrum_fft_src_RADIX22FFT_SDF2_8;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_SDF2_8 IS
  ...
  COMPONENT spectrum_fft_src_SDFCommutator8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : spectrum_fft_src_SDFCommutator8
    USE ENTITY work.spectrum_fft_src_SDFCommutator8(rtl);
...
BEGIN
  u_dataMEM_im_0_8 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_8 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_8 : spectrum_fft_src_SDFCommutator8
    PORT MAP( clk => clk,
              reset => reset,
