-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_SDF1_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_SDF1_5
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_5
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_SDF1_5 IS
...
END spectrum_fft_src_RADIX22FFT_SDF1_5;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_SDF1_5 IS

  -- Component Declarations
  COMPONENT spectrum_fft_src_Complex4Multiply_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT spectrum_fft_src_SDFCommutator5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : spectrum_fft_src_Complex4Multiply_block
    USE ENTITY work.spectrum_fft_src_Complex4Multiply_block(rtl);

  FOR ALL : spectrum_fft_src_SimpleDualPortRAM_generic
    USE ENTITY work.spectrum_fft_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : spectrum_fft_src_SDFCommutator5
    USE ENTITY work.spectrum_fft_src_SDFCommutator5(rtl);
...
BEGIN
  u_MUL4 : spectrum_fft_src_Complex4Multiply_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_5 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_5 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 21
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_5 : spectrum_fft_src_SDFCommutator5
    PORT MAP( clk => clk,
              reset => reset,
              din_5_vld_dly => din_5_vld_dly,
