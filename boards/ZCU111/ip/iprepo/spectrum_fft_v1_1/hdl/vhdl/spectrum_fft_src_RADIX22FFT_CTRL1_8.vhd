-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_RADIX22FFT_CTRL1_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_RADIX22FFT_CTRL1_8
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_CTRL1_8
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_RADIX22FFT_CTRL1_8 IS
...
END spectrum_fft_src_RADIX22FFT_CTRL1_8;


ARCHITECTURE rtl OF spectrum_fft_src_RADIX22FFT_CTRL1_8 IS
  ...
  SIGNAL rd_8_Addr_tmp                    : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_8_Enb <= '0';
        IF (dout_7_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7#, 3))) = '1' THEN 
