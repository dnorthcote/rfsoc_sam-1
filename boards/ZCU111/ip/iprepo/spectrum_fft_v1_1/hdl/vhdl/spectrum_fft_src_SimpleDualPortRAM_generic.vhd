-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_SimpleDualPortRAM_generic.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_SimpleDualPortRAM_generic
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_1/SimpleDualPortRAM_generic
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_SimpleDualPortRAM_generic IS
...
END spectrum_fft_src_SimpleDualPortRAM_generic;


ARCHITECTURE rtl OF spectrum_fft_src_SimpleDualPortRAM_generic IS
