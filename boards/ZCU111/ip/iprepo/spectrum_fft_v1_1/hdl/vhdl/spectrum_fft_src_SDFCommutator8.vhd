-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_fft_hdlcoder\spectrum_fft_src_SDFCommutator8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: spectrum_fft_src_SDFCommutator8
-- Source Path: spectrum_fft_hdlcoder/FFT/FFT HDL Optimized/RADIX22FFT_SDF2_8/SDFCommutator8
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY spectrum_fft_src_SDFCommutator8 IS
...
END spectrum_fft_src_SDFCommutator8;


ARCHITECTURE rtl OF spectrum_fft_src_SDFCommutator8 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL xf_im_signed                     : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL dinf_re_signed                   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL dinf_im_signed                   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL btf1_re_signed                   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL btf1_im_signed                   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL btf2_re_signed                   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL btf2_im_signed                   : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL SDFCummutator_out_re             : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL SDFCummutator_out_im             : signed(23 DOWNTO 0);  -- sfix24
  ...
  SIGNAL SDFCummutator_wrData_re_reg      : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL SDFCummutator_wrData_im_reg      : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL SDFCummutator_wrEnb_reg          : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg     : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL SDFCummutator_wrXData_im_reg     : signed(23 DOWNTO 0);  -- sfix24
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL SDFCummutator_out_im_next        : signed(23 DOWNTO 0);  -- sfix24_En15
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(23 DOWNTO 0);  -- sfix24_En15
  ...
  SIGNAL wrData_re_tmp                    : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL wrData_im_tmp                    : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL wrAddr_tmp                       : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL xData_re                         : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL xData_im                         : signed(23 DOWNTO 0);  -- sfix24_En15
  ...
  SIGNAL dout0_re                         : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL dout0_im                         : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL xX_re_signed                     : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL xX_im                            : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL xX_im_signed                     : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL SDFOutmux_btf2Pipe_re            : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL SDFOutmux_btf2Pipe_im            : signed(23 DOWNTO 0);  -- sfix24
  SIGNAL SDFOutmux_btfPipe_vld            : std_logic;
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_8_1_re_tmp                  : signed(23 DOWNTO 0);  -- sfix24_En15
  SIGNAL dout_8_1_im_tmp                  : signed(23 DOWNTO 0);  -- sfix24_En15

BEGIN
  u_dataXMEM_re_0_8 : spectrum_fft_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_8 : spectrum_fft_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      SDFCummutator_out_re <= to_signed(16#000000#, 24);
      SDFCummutator_out_im <= to_signed(16#000000#, 24);
      SDFCummutator_wrData_re_reg <= to_signed(16#000000#, 24);
      SDFCummutator_wrData_im_reg <= to_signed(16#000000#, 24);
      ...
      SDFCummutator_wrXData_re_reg <= to_signed(16#000000#, 24);
      SDFCummutator_wrXData_im_reg <= to_signed(16#000000#, 24);
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        SDFCummutator_wrXData_re_reg_next <= to_signed(16#000000#, 24);
        SDFCummutator_wrXData_im_reg_next <= to_signed(16#000000#, 24);
  ...
  BEGIN
    IF reset = '1' THEN
      SDFOutmux_btf2Pipe_re <= to_signed(16#000000#, 24);
      SDFOutmux_btf2Pipe_im <= to_signed(16#000000#, 24);
  ...
  BEGIN
    ...
    END IF;
    dout_8_1_re_tmp <= SDFOutmux_btf2Pipe_re;
    dout_8_1_im_tmp <= SDFOutmux_btf2Pipe_im;
    dout_8_1_vld <= SDFOutmux_btfPipe_vld;
  END PROCESS SDFOutmux_output;


  dout_8_1_re <= std_logic_vector(dout_8_1_re_tmp);

  dout_8_1_im <= std_logic_vector(dout_8_1_im_tmp);
