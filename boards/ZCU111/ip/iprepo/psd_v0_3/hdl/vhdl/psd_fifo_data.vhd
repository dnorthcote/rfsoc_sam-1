-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psd_db\psd_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: psd_fifo_data
-- Source Path: psd/psd_axi4_stream_slave/psd_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF psd_fifo_data IS
...
BEGIN
  ...
  u_psd_fifo_data_classic_ram : psd_SimpleDualPortRAM_generic
