-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psd_db\psd_fifo_TUSER_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: psd_fifo_TUSER_OUT
-- Source Path: psd/psd_axi4_stream_master/psd_fifo_TUSER_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END psd_fifo_TUSER_OUT;


ARCHITECTURE rtl OF psd_fifo_TUSER_OUT IS
...
BEGIN
  ...
  u_psd_fifo_TUSER_OUT_classic_ram : psd_SimpleDualPortRAM_singlebit
