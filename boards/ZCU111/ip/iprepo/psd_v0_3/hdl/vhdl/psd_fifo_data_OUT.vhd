-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psd_db\psd_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: psd_fifo_data_OUT
-- Source Path: psd/psd_axi4_stream_master/psd_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END psd_fifo_data_OUT;


ARCHITECTURE rtl OF psd_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT psd_SimpleDualPortRAM_generic
  ...
  FOR ALL : psd_SimpleDualPortRAM_generic
    USE ENTITY work.psd_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_psd_fifo_data_OUT_classic_ram_generic : psd_SimpleDualPortRAM_generic
