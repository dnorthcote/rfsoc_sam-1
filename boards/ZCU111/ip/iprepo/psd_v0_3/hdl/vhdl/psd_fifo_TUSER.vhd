-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psd_db\psd_fifo_TUSER.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: psd_fifo_TUSER
-- Source Path: psd/psd_axi4_stream_slave/psd_fifo_TUSER
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF psd_fifo_TUSER IS
...
BEGIN
  ...
  u_psd_fifo_TUSER_classic_ram : psd_SimpleDualPortRAM_singlebit
