-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psd_db\psd_fifo_TLAST.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: psd_fifo_TLAST
-- Source Path: psd/psd_axi4_stream_slave/psd_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF psd_fifo_TLAST IS
...
BEGIN
  ...
  u_psd_fifo_TLAST_classic_ram : psd_SimpleDualPortRAM_singlebit
