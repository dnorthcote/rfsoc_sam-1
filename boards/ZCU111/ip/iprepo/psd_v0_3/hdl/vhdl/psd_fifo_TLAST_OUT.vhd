-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psd_db\psd_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: psd_fifo_TLAST_OUT
-- Source Path: psd/psd_axi4_stream_master/psd_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END psd_fifo_TLAST_OUT;


ARCHITECTURE rtl OF psd_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT psd_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : psd_SimpleDualPortRAM_singlebit
    USE ENTITY work.psd_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_psd_fifo_TLAST_OUT_classic_ram_singlebit : psd_SimpleDualPortRAM_singlebit
