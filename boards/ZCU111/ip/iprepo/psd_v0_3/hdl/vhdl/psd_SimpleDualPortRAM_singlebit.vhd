-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psd_db\psd_SimpleDualPortRAM_singlebit.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: psd_SimpleDualPortRAM_singlebit
-- Source Path: psd/psd_axi4_stream_master/psd_fifo_TLAST_OUT/psd_fifo_TLAST_OUT_classic/psd_SimpleDualPortRAM_singlebit
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY psd_SimpleDualPortRAM_singlebit IS
...
END psd_SimpleDualPortRAM_singlebit;


ARCHITECTURE rtl OF psd_SimpleDualPortRAM_singlebit IS
...
BEGIN
  ...
  psd_SimpleDualPortRAM_singlebit_process: PROCESS (clk)
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS psd_SimpleDualPortRAM_singlebit_process;
