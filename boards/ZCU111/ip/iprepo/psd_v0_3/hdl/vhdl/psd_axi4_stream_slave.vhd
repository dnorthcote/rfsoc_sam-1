-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psd_db\psd_axi4_stream_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: psd_axi4_stream_slave
-- Source Path: psd/psd_axi4_stream_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY psd_axi4_stream_slave IS
...
END psd_axi4_stream_slave;


ARCHITECTURE rtl OF psd_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT psd_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : psd_fifo_data
    USE ENTITY work.psd_fifo_data(rtl);

  FOR ALL : psd_fifo_TLAST
    USE ENTITY work.psd_fifo_TLAST(rtl);

  FOR ALL : psd_fifo_TUSER
    USE ENTITY work.psd_fifo_TUSER(rtl);
...
BEGIN
  u_psd_fifo_data_inst : psd_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_psd_fifo_TLAST_inst : psd_fifo_TLAST
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_psd_fifo_TUSER_inst : psd_fifo_TUSER
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
