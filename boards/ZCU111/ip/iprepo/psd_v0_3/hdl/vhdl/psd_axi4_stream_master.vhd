-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psd_db\psd_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: psd_axi4_stream_master
-- Source Path: psd/psd_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY psd_axi4_stream_master IS
...
END psd_axi4_stream_master;


ARCHITECTURE rtl OF psd_axi4_stream_master IS

  -- Component Declarations
  COMPONENT psd_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : psd_fifo_data_OUT
    USE ENTITY work.psd_fifo_data_OUT(rtl);

  FOR ALL : psd_fifo_TLAST_OUT
    USE ENTITY work.psd_fifo_TLAST_OUT(rtl);

  FOR ALL : psd_fifo_TUSER_OUT
    USE ENTITY work.psd_fifo_TUSER_OUT(rtl);
...
BEGIN
  u_psd_fifo_data_OUT_inst : psd_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_psd_fifo_TLAST_OUT_inst : psd_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_psd_fifo_TUSER_OUT_inst : psd_fifo_TUSER_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
