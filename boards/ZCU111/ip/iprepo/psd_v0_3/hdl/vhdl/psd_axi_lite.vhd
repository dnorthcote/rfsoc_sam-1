-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psd_db\psd_axi_lite.vhd
...
ARCHITECTURE rtl OF psd_axi_lite IS

  -- Component Declarations
  COMPONENT psd_addr_decoder
  ...
  FOR ALL : psd_addr_decoder
    USE ENTITY work.psd_addr_decoder(rtl);

  FOR ALL : psd_axi_lite_module
    USE ENTITY work.psd_axi_lite_module(rtl);
  ...
  SIGNAL write_output_selection_tmp       : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_window_tmp                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_rbw_tmp                    : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_psd_addr_decoder_inst : psd_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_output_selection => write_output_selection_tmp,  -- ufix32
              write_window => write_window_tmp,  -- ufix32
              write_rbw => write_rbw_tmp  -- ufix32
              );

  u_psd_axi_lite_module_inst : psd_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_output_selection <= write_output_selection_tmp;

  write_window <= write_window_tmp;

  write_rbw <= write_rbw_tmp;
