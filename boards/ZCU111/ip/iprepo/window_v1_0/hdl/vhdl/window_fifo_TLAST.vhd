-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simple_window\window_fifo_TLAST.vhd
-- Created: 2020-10-19 09:33:56
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: window_fifo_TLAST
-- Source Path: window/window_axi4_stream_window_slave/window_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END window_fifo_TLAST;


ARCHITECTURE rtl OF window_fifo_TLAST IS
...
BEGIN
  ...
  u_window_fifo_TLAST_classic_ram : window_SimpleDualPortRAM_singlebit
