-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simple_window\window_fifo_TUSER_OUT_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: window_fifo_TUSER_OUT_block
-- Source Path: window/window_axi4_stream_imag_master/window_fifo_TUSER_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY window_fifo_TUSER_OUT_block IS
...
END window_fifo_TUSER_OUT_block;


ARCHITECTURE rtl OF window_fifo_TUSER_OUT_block IS

  -- Component Declarations
  COMPONENT window_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : window_SimpleDualPortRAM_singlebit
    USE ENTITY work.window_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_window_fifo_TUSER_OUT_classic_ram : window_SimpleDualPortRAM_singlebit
