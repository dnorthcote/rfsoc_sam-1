-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simple_window\window_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: window_fifo_TLAST_OUT
-- Source Path: window/window_axi4_stream_real_master/window_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY window_fifo_TLAST_OUT IS
...
END window_fifo_TLAST_OUT;


ARCHITECTURE rtl OF window_fifo_TLAST_OUT IS
...
BEGIN
  ...
  u_window_fifo_TLAST_OUT_classic_ram_singlebit : window_SimpleDualPortRAM_singlebit
