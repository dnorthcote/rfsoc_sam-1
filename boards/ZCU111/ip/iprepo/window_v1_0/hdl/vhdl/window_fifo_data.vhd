-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simple_window\window_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: window_fifo_data
-- Source Path: window/window_axi4_stream_window_slave/window_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END window_fifo_data;


ARCHITECTURE rtl OF window_fifo_data IS
...
BEGIN
  ...
  u_window_fifo_data_classic_ram_generic : window_SimpleDualPortRAM_generic
