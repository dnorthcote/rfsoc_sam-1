-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simple_window\window_axi4_stream_real_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: window_axi4_stream_real_master
-- Source Path: window/window_axi4_stream_real_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY window_axi4_stream_real_master IS
...
END window_axi4_stream_real_master;


ARCHITECTURE rtl OF window_axi4_stream_real_master IS

  -- Component Declarations
  COMPONENT window_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT window_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT window_fifo_TUSER_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : window_fifo_data_OUT
    USE ENTITY work.window_fifo_data_OUT(rtl);

  FOR ALL : window_fifo_TLAST_OUT
    USE ENTITY work.window_fifo_TLAST_OUT(rtl);

  FOR ALL : window_fifo_TUSER_OUT
    USE ENTITY work.window_fifo_TUSER_OUT(rtl);
...
BEGIN
  u_window_fifo_data_OUT_inst : window_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_window_fifo_TLAST_OUT_inst : window_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_window_fifo_TUSER_OUT_inst : window_fifo_TUSER_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
