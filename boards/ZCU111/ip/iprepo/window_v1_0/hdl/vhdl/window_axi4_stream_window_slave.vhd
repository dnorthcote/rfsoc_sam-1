-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simple_window\window_axi4_stream_window_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: window_axi4_stream_window_slave
-- Source Path: window/window_axi4_stream_window_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY window_axi4_stream_window_slave IS
...
END window_axi4_stream_window_slave;


ARCHITECTURE rtl OF window_axi4_stream_window_slave IS

  -- Component Declarations
  COMPONENT window_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : window_fifo_data
    USE ENTITY work.window_fifo_data(rtl);
...
BEGIN
  u_window_fifo_data_inst : window_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              In_rsvd => AXI4_Stream_Window_Slave_TDATA,  -- ufix16
              Push => AXI4_Stream_Window_Slave_TVALID,  -- ufix1
  ...
  AXI4_Stream_Window_Slave_TREADY <=  NOT fifo_full;
