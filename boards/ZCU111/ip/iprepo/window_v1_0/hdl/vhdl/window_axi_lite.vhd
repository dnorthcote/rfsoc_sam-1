-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simple_window\window_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: window_axi_lite
-- Source Path: window/window_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF window_axi_lite IS

  -- Component Declarations
  COMPONENT window_addr_decoder
  ...
  COMPONENT window_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : window_addr_decoder
    USE ENTITY work.window_addr_decoder(rtl);

  FOR ALL : window_axi_lite_module
    USE ENTITY work.window_axi_lite_module(rtl);
...
BEGIN
  u_window_addr_decoder_inst : window_addr_decoder
  ...
  u_window_axi_lite_module_inst : window_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
