-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simple_window\window_axi4_stream_imag_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: window_axi4_stream_imag_master
-- Source Path: window/window_axi4_stream_imag_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY window_axi4_stream_imag_master IS
...
END window_axi4_stream_imag_master;


ARCHITECTURE rtl OF window_axi4_stream_imag_master IS

  -- Component Declarations
  COMPONENT window_fifo_data_OUT_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT window_fifo_TLAST_OUT_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT window_fifo_TUSER_OUT_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : window_fifo_data_OUT_block
    USE ENTITY work.window_fifo_data_OUT_block(rtl);

  FOR ALL : window_fifo_TLAST_OUT_block
    USE ENTITY work.window_fifo_TLAST_OUT_block(rtl);

  FOR ALL : window_fifo_TUSER_OUT_block
    USE ENTITY work.window_fifo_TUSER_OUT_block(rtl);
...
BEGIN
  u_window_fifo_data_OUT_inst : window_fifo_data_OUT_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_window_fifo_TLAST_OUT_inst : window_fifo_TLAST_OUT_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_window_fifo_TUSER_OUT_inst : window_fifo_TUSER_OUT_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
