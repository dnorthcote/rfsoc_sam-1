-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simple_window\window_axi4_stream_imag_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: window_axi4_stream_imag_slave
-- Source Path: window/window_axi4_stream_imag_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY window_axi4_stream_imag_slave IS
...
END window_axi4_stream_imag_slave;


ARCHITECTURE rtl OF window_axi4_stream_imag_slave IS

  -- Component Declarations
  COMPONENT window_fifo_data_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : window_fifo_data_block1
    USE ENTITY work.window_fifo_data_block1(rtl);
...
BEGIN
  u_window_fifo_data_inst : window_fifo_data_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
