-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simple_window\window_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: window_fifo_data_OUT
-- Source Path: window/window_axi4_stream_real_master/window_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY window_fifo_data_OUT IS
...
END window_fifo_data_OUT;


ARCHITECTURE rtl OF window_fifo_data_OUT IS
